...
| <a name="input_polytomic_logger_service_account"></a> [polytomic\_logger\_service\_account](#input\_polytomic\_logger\_service\_account) | GCP service account email for Vector DaemonSet Workload Identity. Required when polytomic\_use\_logger is true for GCS write access. | `string` | `""` | no |
